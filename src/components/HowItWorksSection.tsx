    ...
    <section id="how-it-works" className="py-24 bg-muted/50">
      <div className="container mx-auto px-6">
        ...
        <div className="relative grid gap-8 md:grid-cols-3">
          {/* Connecting line */}
          <div className="absolute top-16 left-[16.6%] right-[16.6%] hidden h-0.5 bg-gradient-to-r from-secondary via-emerald to-secondary md:block" />
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="relative z-10 mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary shadow-card-hover">
                <step.icon className="h-7 w-7 text-primary-foreground" />
              </div>
              <span className="mb-2 text-sm font-bold text-secondary">{step.number}</span>
